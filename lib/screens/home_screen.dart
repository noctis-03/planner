          ...
          children: [
            ...
            Expanded(
              child: Row(
                ...
                children: [
                  // 좌측 보관함 사이드바 (창 폭에 비례해서 축소)
                  LayoutBuilder(
                    builder: (context, c) {
                      final screenW = MediaQuery.of(context).size.width;
                      // 창이 좁을수록 사이드바도 좁게 (최소 200, 최대 300)
                      final sidebarW =
...
class _PlannerBoard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, c) {
        // 창이 아무리 좁아져도 7일이 항상 한 화면에 균등하게 들어감.
        // 가로 스크롤 없음.
        const hPad = 12.0;
        const gap = 6.0;
        final available = c.maxWidth - hPad * 2;
        final colW = (available - gap * 6) / 7;
