...
class AppTokens {
  ...
  static const Color accent = Color(0xFF8FB3E8); // 파스텔 블루 (주 포인트)
  static const Color accentSoft = Color(0xFFEEF4FC);
  static const Color danger = Color(0xFFEF9A9A); // 파스텔 레드
